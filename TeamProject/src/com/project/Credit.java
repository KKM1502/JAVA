...
public class Credit {
	...
	//신용카드 정보 
	public Credit(String event, String credit, String no, String cardName, String annual, String pre, String benefit) {
		super();
		this.event = event;
		this.credit = credit;
		this.no = no;
	...
	public String toString() {
		return "Credit [event=" + event + ", credit=" + credit + ", no=" + no + ", cardName=" + cardName + ", annual="
